...
download.file("https://gss.norc.org/Documents/spss/2018_spss.zip",
              "2018_spss.zip", mode = "wb")
dir()
...
# Scripts van tutorials op Github: https://github.com/ejvingen/OEI_Github
